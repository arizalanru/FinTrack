            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  ...
                  _menuItem(context, Icons.lock, "Ubah Password", '/change-password'),
                  _menuItem(context, Icons.account_balance_wallet, "Dompet", '/wallet'),
                  _menuItem(context, Icons.info, "Tentang Kami", '/about'),
                  _menuItem(context, Icons.description, "S&K", '/terms'),
                  _menuItem(context, Icons.privacy_tip, "Kebijakan Privasi", '/privacy'),
                  _menuItem(context, Icons.email, "Hubungi Kami", '/contact'),
